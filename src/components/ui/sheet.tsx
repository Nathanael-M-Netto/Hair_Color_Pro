...
/**
 * Sheet — painel lateral (bottom, left, right, top).
 * No mobile (iPhone/Android) o padrão recomendado é `side="bottom"`.
 * Usa glass-strong para ser distinto do fundo.
 */
...
const sheetVariants = cva(
  'fixed z-50 gap-4 glass-strong p-6 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
